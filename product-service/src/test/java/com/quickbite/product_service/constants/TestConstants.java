...
public class TestConstants {
    ...
    public static final String RESTAURANT_EMAIL = "restaurant@test.com";
    public static final String RESTAURANT_PHONE_1 = "+5511999999999";
    ...
    public static final String RESTAURANT_ALREADY_EXISTS_MESSAGE = "Restaurant with name '%s' already exists for this owner";
    ...
    public static final String INVALID_RATING_MESSAGE = "Minimum rating must be between 0 and 5";
    ...
    public static final String CUISINE_TOO_LONG_MESSAGE = "Cuisine type must not exceed 100 characters";
